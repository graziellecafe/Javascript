...
function compraSupermercado(valorCompra){
    ...
    if(valorCompra < 60){
        ...
        if(valorCompra < 55){
            let notasDeCincoReais = Math.floor(valorCompra/5);
            console.log(`Notas de cinco: ${notasDeCincoReais}`);

            let notasDeUmReal = valorCompra - (notasDeCincoReais*5);
            console.log(`Notas de um: ${notasDeUmReal}`);
        }

        if(valorCompra >= 55){
            let notasDeCincoReais = Math.floor(valorCompra/5) - 1;
            console.log(`Notas de cinco: ${notasDeCincoReais}`);
